 ...
 */
public class TeraGenNull extends Configured implements Tool {
  private static final Log LOG = LogFactory.getLog(TeraGenNull.class);
  ...
  public int run(String[] args) 
    ...
    job.setJarByClass(TeraGenNull.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new TeraGenNull(), args);
    System.exit(res);
  }
}