 ...
 */
public class TeraGenZero extends Configured implements Tool {
  private static final Log LOG = LogFactory.getLog(TeraGenZero.class);
  ...
  public int run(String[] args) 
    ...
    job.setJarByClass(TeraGenZero.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new TeraGenZero(), args);
    System.exit(res);
  }
}